...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 26, 2021 at 06:55 PM
...
(7, 10000000, '31 December, 2021', '02 January, 2022', '/images/proof/about.jpg', 2, 6, 'pending');
...
--
ALTER TABLE `customer`
  MODIFY `customer_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
